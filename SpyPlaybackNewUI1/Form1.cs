    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    log.Error(curtime + " - AUT NOT FOUND");
        ...
        // Playback button on Playback Script
        private void btnPlaybackTestScript_Click_1(object sender, EventArgs e)
        {
            Thread t = new Thread(() => ClearTextBox.ClearValue(ProcessName));
            t.Start();
            t.Join();
        ...
        // Playback button on Playback Table // Add log 
        ...
        public void PlaybackTestSteps()
        {
            ...
            ResultPanelPush.Clear();
            ConsolePanelPush.AppendText(curtime + "BEGIN PLAYBACK");
            ConsolePanelPush.AppendText(Environment.NewLine);
            ...
            try
            {
                ...
                foreach (DataGridViewRow row in dataGridView2.Rows)
                {
                    ...
                    else if (PlaybackObjectList[pbindex].action == "SetText" || PlaybackObjectList[pbindex].action == "WaitEnable" || PlaybackObjectList[pbindex].action == "SendKey")
                    {
                ...
                for (int i = 0; i < PlaybackObjectList.Count(); i++)
                {
                    ...
                    {
                        case "Button":
                            AbsAction ButtonAction = new SpyandPlaybackTestTool.Actions.ButtonAction();
                            ButtonAction.PlaybackObject = PlaybackObjectList[i];
                            ButtonAction.UiElement = ElementList[PlaybackObjectList[i].index];
                            ButtonAction.DoExecute();
                            if (ButtonAction.Result == true)
                        ...
                        case "RadioButton":
                            AbsAction RadioButtonAction = new SpyandPlaybackTestTool.Actions.RadioButtonAction();
                            RadioButtonAction.PlaybackObject = PlaybackObjectList[i];
                            RadioButtonAction.UiElement = ElementList[PlaybackObjectList[i].index];
                            RadioButtonAction.DoExecute();
                            if (RadioButtonAction.Result == false)
                        ...
                        case "TextBox":
                            AbsAction TextBoxAction = new SpyandPlaybackTestTool.Actions.TextBoxAction();
                            TextBoxAction.PlaybackObject = PlaybackObjectList[i];
                            TextBoxAction.UiElement = ElementList[PlaybackObjectList[i].index];
                            TextBoxAction.DoExecute();
                            if (TextBoxAction.Result == true)
                        ...
                        case "CheckBox":
                            AbsAction CheckBoxAction = new SpyandPlaybackTestTool.Actions.CheckBoxAction();
                            CheckBoxAction.PlaybackObject = PlaybackObjectList[i];
                            CheckBoxAction.UiElement = ElementList[PlaybackObjectList[i].index];
                        ...
                        case "AutoCompleteCombobox":
                            AbsAction ATComboBoxEditAction = new SpyandPlaybackTestTool.Actions.ComboBoxEditAction();
                            ...
                            if (ATComboBoxEditAction.Result == false)
                            {
                                log.Fatal("FAILED at item id: " + ATComboBoxEditAction.PlaybackObject.index + " --- " + "ClassType: " + ATComboBoxEditAction.UiElement.ClassName);
                                ResultPanelPush.AppendText(curtime + " - " + "FAILED at item id: " + ATComboBoxEditAction.PlaybackObject.index + " --- " + "ClassType: " + ATComboBoxEditAction.UiElement.ClassName);
                                ResultPanelPush.AppendText(Environment.NewLine);
                            }
                            else
                            {
                                log.Info("PASSED at item id: " + ATComboBoxEditAction.PlaybackObject.index + " --- " + "ClassType: " + ATComboBoxEditAction.UiElement.ClassName);
                                ResultPanelPush.AppendText(curtime + " - " + "PASSED at item id: " + ATComboBoxEditAction.PlaybackObject.index + " --- " + "ClassType: " + ATComboBoxEditAction.UiElement.ClassName);
                                ResultPanelPush.AppendText(Environment.NewLine);
                            }
                            break;
                        ...
                        case "SendKeyorWaitEnable":
                            ...
                            {
                                AbsAction WaitEnable = new SpyandPlaybackTestTool.Actions.WaitEnable();
                                WaitEnable.PlaybackObject = PlaybackObjectList[i];
                                WaitEnable.DoExecute();
                            }
                            break;
        ...
        private void btnQuickSave_Click(object sender, EventArgs e)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("There is no test script file!", "NOTICE", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            int i = 0;
            ...
            System.Windows.Forms.MessageBox.Show("Save succeeed!");
        }
        ...
        {
            if (dataGridView2.Rows.Count == 0)
                System.Windows.Forms.MessageBox.Show("There is no data!", "NOTICE", MessageBoxButtons.OK, MessageBoxIcon.Information);
            else
            {
                DialogResult dialogResult = System.Windows.Forms.MessageBox.Show("Do you really want to remove this row?", "WARNING", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        private void textBox1_TextChanged_1(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < SpyObjectList.Count(); i++)
            {
                ...
                if ((search.Contains(text) == true || search1.Contains(text) == true) && (comboBox1.SelectedItem.ToString() == "All" || (comboBox1.SelectedItem.ToString() == "Interactive Controls" && (SpyObjectList[i].type == "ComboBox" || SpyObjectList[i].type == "ComboBoxEdit" || SpyObjectList[i].type == "AutoCompleteCombobox" || SpyObjectList[i].type == "DataGrid" || SpyObjectList[i].type == "TextBox" || SpyObjectList[i].type == "Button" || SpyObjectList[i].type == "RadioButton"))) && SpyObjectList[i].automationId.Contains("PART") != true)
                {
        ...
        private void comboBox1_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            ...
            switch (comboBox1.SelectedItem.ToString())
            {
                ...
                case "CheckBox":
                    ...
                    for (int i = 0; i < SpyObjectList.Count(); i++)
                    {
                        if (SpyObjectList[i].type == "CheckBox" && SpyObjectList[i].automationId.Contains("PART") != true)
                        {
                            int rowId = dataGridView1.Rows.Add();
                            DataGridViewRow row = dataGridView1.Rows[rowId];
                            row.Cells[1].Value = SpyObjectList[i].index;
                ...
                case "Interactive Controls":
                    ...
                    for (int i = 0; i < SpyObjectList.Count(); i++)
                    {
                        if ((SpyObjectList[i].type == "ComboBox" || SpyObjectList[i].type == "ComboBoxEdit" || SpyObjectList[i].type == "DataGrid" || SpyObjectList[i].type == "TextBox" || SpyObjectList[i].type == "Button" || SpyObjectList[i].type == "RadioButton" || SpyObjectList[i].type == "AutoCompleteCombobox" || SpyObjectList[i].type == "CheckBox") && SpyObjectList[i].automationId.Contains("PART") != true)
                        {
                            int rowId = dataGridView1.Rows.Add();
                            DataGridViewRow row = dataGridView1.Rows[rowId];
                            row.Cells[1].Value = SpyObjectList[i].index;
        ...
        private void InspectorToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            HLightForm.ProcessName = ProcessName;
            HLightForm.Show();
        ...
        private void btnPlaybackScenario_Click(object sender, EventArgs e)
        {
            if (ProcessName == "")
            {
                System.Windows.Forms.MessageBox.Show("Please attach AUT process!", "WARNING", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            if (clbTestScriptList.Items.Count <= 0)
            {
                System.Windows.Forms.MessageBox.Show("There is no checked test script file!", "NOTICE", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            //clbTestScriptList.SelectedIndex = 2;
            ...
            for (int i = 0; i < indexList.Count; i++)
            {
                ...
                //System.Windows.Forms.MessageBox.Show(rtxtScript.Text);
                PlaybackTestScript();
                //Thread.Sleep(4000);
            }
        }
        ...
        private void ConsolePanelPush_TextChanged(object sender, EventArgs e)
        {
            ...
            this.CheckKeyWord("PLAYBACK DONE", Color.Green, 0);
